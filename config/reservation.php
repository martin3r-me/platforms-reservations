    ...
    'sidebar' => [
        ...
        [
            ...
            'items' => [
                ...
                ['label' => 'Produkte', 'route' => 'reservation.menu.index', 'icon' => 'heroicon-o-rectangle-stack'],
                ['label' => 'Produkt-Import', 'route' => 'reservation.menu.import', 'icon' => 'heroicon-o-arrow-up-tray'],
